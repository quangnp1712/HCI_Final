...
Designing usable interactive products requires considering ... 1.Who is going to be using them 2. What they are going to be used 3.How they are going to be used 4.Where they are going to be used | 1.3.4
The usability test conditions should be ____ for each participant | Different
What is usable? | Easy to learn, effective to use, and providing an enjoyable user expenrience
Annotating involves modifying external representation? | True
"By interaction design, we mean designing (a) products to support the way people (b) in their everyday and working lives."| interactive , communicate
Which is the disadvantage of high-fidelity prototype? | More expensive to develop
The distributed cognition approach studies _ ? | The nature of cognitive phenomera
Exploration is the type of interaction where users have a dialog with system | True
Expert critiques (crits) can be formal or informal reports | True
How many phases have a basis RAD lifecycle model? | 5
What is a user-centered approach? | All 
Effectiveness is the usability goals ? | True
Contextual inquiry rests on what main principles | Context, partnership, interpretations and focus
GOMS has also been developed to provide a quantitative model - the keystroke level model | True
Which basic activity in Interaction Design can be broken up into 2 sub-activitives: Conceptual design and Physical design? | Developing alternative designs
What is the concept that has become the central of interaction design ? | User experience
Which is the forth activity of interaction design | Evaluating designs
On the door's handle, you have seen the sign "DO NOT DISTURB". Is that the ATTENTION? | True
Usability and preference for these control devices varies depends on the dexterity and commitment of the user | true
Which is the first key issues of data gathering | Setting goals
Developing interactive prototype is the step of design phase in Interaction Design? | True
Which is not usability goals? | user experience
A computer expert produces an solution with HCI which is very efficient in computer resources, based on command-lines. Which one of the following is most likely to be the result when the system is implemented? | Most staff will feel demoralised and will not want to use the system.
Select the incorrect statements | User-centered methods are straight and their phases are separate
Choose the incorrect statements | Central to Interaction design is determining to design the user experience
List the academic disciplines contributing to Interaction Design | All of the others
What are the advantages of working in multidisciplinary teams? | more ideas and designs generated
What does "accessible" mean? | "Accessible" means that it can be used by the full range of intended users
What activity can be considered as the heart of interaction design? | Evaluation
What does "useful" mean? | 'Useful' means that the users can actually achieve the task they want to.
Which is the incorrect statement from the list bellow? | User-centred methods are straight and their phases are separate
Choose the correct statement about Human Interaction Design (HCI) | HCI concerns with the design, evaluation and implementation of interactive computing system for human use and with the study of major phenomena surrounding them.
Which is the most important activity in the process of interaction design? | Evaluating what is being built
Which is NOT usability goals in interaction design? | User experience
Which one of these is a good reason to include sounds in an HCI? | Users react more quickly to sounds than to visual signals
Select correct statements about conceptual models | It is a structure outlining the concepts and the relationships between them
When was the phrase 'natural computing' coined by Stephen Pinker? | 1997
One of the key feature of UCSD is to build simple models of | All
The advantages of working in multidisciplinary teams is | more ideas and designs generated
To understand the problem space we need to ask the following questions | All
All of the following are principles of Natural Computing except? | What can system do
To understand the problem space we need to ask the following questions | All
Which of the following statements does not belong to "Universal Access"? | It promotes the notion of careful design and design standards, so that users with special needs are not excluded from the use of a system
Which of the following does not belong to Dix's principles? | Interoperability
Multiply 2 by 3 in your head is easy. But you are trying to multiplying 234 by 456 in your head. Not as easy. So you try to using pen and paper, and then try again with calculator. It is easier. What is cognition framework considered here? | External cognition
What is cognition? | Cognition is what goes on in our head when we carry out our everyday activities. 
What does MHP stand for? | Model human processor
Which of the following statements belong to 'Visibility of system status' rule developed by Nielsen? | Always keep the user informed about what is going on through providing appropriate feedback in a reasonable time
Which of the following statements belong to 'Visibility of system status' rule developed by Nielsen? | Always keep the user informed about what is going on through providing appropriate feedback in a reasonable time
What do you do if you working with children in gathering data? | For pre-reading or early reading age, data gathering session need to rely on images and chat
Which is  NOT a design implication for supporting user's memory? | Design interface that promote recall rather than recognition
In virtual reality which of the senses cannot currently be portrayed? | Smell
Which of the following statements belong to 'Consistency and standards' rule developed by Nielsen? | Avoid making users wonder if different words, situations or actions mean the same thing
Which is NOT a design implication for user's attention? | None
All of the following statements about attention are true except | Information at the interface should be structured to avoid users' attention
What are design rules? | Design rules are principles that have been interpreted for a particular design
What kind of cognition shows that design interface should promote recognition than recall? | Memory
What are explicit cues of conversations? | saying "Oh dear, must go, look at the time, I'm late"
In communication, _____also used to emphasize and as substitute | non-verbal
Which of the following statements belong to 'Visibility of system status' rule developed by Nielsen? | Always keep the user informed about what is going on through providing appropriate feedback in a reasonable time
In a nutshell, what do a conceptual model provide ? | All
Multiply 2 by 3 in your head is easy. But you are trying to multiplying 234 by 456 in your head. Not as easy. So you try to using pen and paper, and then try again with calculator. It is easier. What is cognition framework considered here? | External cognition
What is the kind of the conversations that are supported in real-time through voice or typing? | Synchronous computer-mediated communication
Select the correct statement for reading, speaking, and listening: | Listening requires less cognitive effort than reading or speaking
Which of these is not a interface style? | Voice Recognition
One of the key feature of UCSD is to build simple models of | All
Select the correct statements about shared external representations | All
List the academic disciplines contributing to Interaction Design | All
______used to organize regular activities in large organizations | Schedules
Which is  NOT a design implication for supporting user's memory? | Design interface that promote recall rather than recognition
The advantages of working in multidisciplinary teams is | more ideas and designs generated
Select explicit cues of conversations | saying "Oh dear, must go, look at the time, I'm late"
What is a user-centered approach? | All
Which of the following belong to criticisms of anthropomorphism? | All
_____ of affect provide a way of conceptualizing emotional and pleasurable aspects of interaction design | Models
Users have created a range of ____ compensate for lack of expressiveness in text communication | emoticons 
______ aspects are concerned with how interactive systems make people respond in emotional ways | Affective
What does HTA stand for? | Hierarchical task analysis
Select the good recommendations for good error messages | All
What does HTA involve? | All
Currently many common environments for interactive computing are examples of the ____________ interface style, often simply called windowing systems. | WIMP
Which is not an input to task analysis? | Storyboard
The purpose of a task analysis is to help designers to understand | All
Select correct statements about conceptual models | It is a structure outlining the concepts and the relationships between them
What are criticisms of anthropomorphism? | All
"I" character in WIMP , a type of  interface,  stands for: | Icons
Select the core design concern with wearable interface: | Users need to feel comfortable wearing clothing with embedded with technology.
Which interface is developed in 1980s? | Command line interfaces.
X-rays and scans machine, which are being used in medicine, is an example of __________. | Augmented and mixed reality interfaces.
______ interfaces are designed for more than one person to use. | Shareable
Which interface uses a  type of sensor-based interaction, where physical objects, e.g bricks, balls.. are coupled with digital representations? | Tangible interface
Which is NOT a kind of menu interface? | none
Select correct statements: | All
______ is a type of sensor-based interaction, where physical objects, e.g bricks, balls.. are coupled with digital representations. | Tangible interface
What is interface designed for more than one person to use? | Shareable interface
A ____ interface is where a person talks with a system that has a spoken language application for inquiring about specific information or to perform transactions... | speech
Consider a situation that you are designing a prototype of collaboration toy for children. Which evaluation approach is suitable in this situation? | Field studies
Which kind of interface that is design for more than one person to use provide multiple inputs, a small group can be interact together? | Shareable interface
Which kind of interface is where a person talks with system that has a spoken language application? | Speech interface
__________ allow(s) views of the real world are combined with views of a virtual environtmental, e.g X-rays and scan using in medicine. | Augmented and mixed reality interface
X-ray, which are overlaid on part of patient's body to aid the physician's understanding of what is being examined, is an example of ____ interface. | augmented reality
____________ are designed for devices that are handheld and intended to be used while on the move. | Mobile interfaces
"Using pen and paper to solve a math problem" is an example of | Computational offloading
A computer expert produces an efficent solution based on command-lines interface. How will the solution be when deploying it? | Most staff will feel demoralised and will not want to use the system.
Select the most expensive data recording method | Video recording
Attention, perception and recognition are parts of? | Cognition
The interaction logging is a technique of the _____________ to gather data | Indirect observation
Which is not a type of qualitative analysis? | None of the others
What is/are correct about pilot studies? | Small trials of main study
How many evaluation approaches? | 3
____ analysis expresses the nature of elements and is represented as themes, patterns, stories | Qualitative
In Norman's theory of action, there are ____ stages of an activity when users interact with the interface. | 7
Building things from user's perspective is called ____ | Usability
A computer expert produces an solution with HCI which is very efficient in computer resources, based on command-lines. Which one of the following is most likely to be the result when the system is implemented? | Most staff will feel demoralised and will not want to use the system.
The best way to present your findings depends on the ____ , the purpose, and the data gathering and analysis undertaken | audience
How many basic steps are there in interaction design process? | 4
The term __________ is used to represent a model that captures a set of activities and how they are related. | lifecycle model
Select the central activity of Star lifecycle model in HCI | Evaluation
Which is the category of users who frequent hands-on your product? | Primary
To design good error messages, try to avoid using term like FATAL, ERROR, INVALID, BAD and ELLIGAL. | True
Post-test questionnaires (conducted after a usability test) are particularly useful for measuring | user satisfaction
___ is an approach to evaluation that does not involve end-users | Analytical evaluation
Which is software development lifecycle model? | Rapid Application Development
After usability testing, a questionnaires are particularly useful for measuring ____________ of product. | user satisfaction
Select the first activity in interaction design process? | Identify users needs and establishing requirements
How many steps in Interaction Design? | 4
Which is NOT practical issue in Interaction Design? | How do you protect the people's privacy?
Form-filling interfaces are used for | data entry
The ___________ or consistency of a method is how well it produces the same result on separate occasions under the same circumstances. | Reliability
Which of the following guidelines does not belong to "Simple And Intuitive Use" principles? | Discourage unconscious action in tasks that require vigilance.
A pluralistic walkthrough | is often conducted with low-fidelity designs.
What does "Flexibility In Use" mean? | It means that the design accommodates a wide range of individual preferences and abilities.
With the blind user, the website's information has to provide __________ navigation to assist blind users | Audio
Select data gathering technique that is not often used in requirements activity: | Indirect observation
User and system has its own unique language, the language used by the user is called_____ | Task
A pluralistic walkthrough| is often conducted with low-fidelity designs.
Two common types of Compromises in prototyping ______: provide a wide range of functions, but with little detail ______: provide a lot of detail for only a few functions | horizontal; vertical
Select the criticisms of anthropomorphism | Deceptive, make people feel anxious, inferior or stupid
Which are disadvantages of low-fidelity prototype? | None
A prototype can be | All
One of the 7 principles of universal design is FLEXIBILITY IN USE which means that use of the design is easy to understand, regardless of the user's experience, knowledge, language skills, or current concentration level. | False
______ is a series of sketches showing how a user might progress through a task using the device | Storyboard
Which is NOT a task description type? | HTA
Stakeholders can see, hold, interact with a _____ more easily than a document or a drawing | prototype
Select the evaluation method that does not require participant of user or expert. | heuristic evaluation.
DECIDE framework has ___ items | 6
The first item of the DECIDE framework is | Determine the goals
How many main evaluation approach are used in Interaction Design? | 3
_________ frequent your primary personas access the site,____________ transient a stance the site needs to take (respectively). | Less, More
Which method is not used in the field studies evaluation approach? | Modeling
Select the evaluation approach in which asking experts method is mainly applied: | Analytical evaluation
Where should we evaluate whether children enjoy playing with a collaborative toy? | natural settings
The ______ framework provides a useful checklist for planning an evaluation study. | DECIDE
Which of the followings do not belong to the items of the DECIDE framework? | none
A method that does not require human participants serving as test users is the | heuristic evaluation.
Which kind of evaluation approach in which user indirectly involve? | Field studies
Which is NOT disadvantages for lo-fi prototype | They make design idea visual
Which of the following statements about human memory is true? | We overestimate our memory capacity
What does "accessible" mean? | "Accessible" means that it can be used by the full range of intended users
Multiply 2 by 3 in your head is easy. But you are trying to multiplying 234 by 456 in your head. Not as easy. So you try to using pen and paper, and then try again with calculator. It is easier. What is cognition framework considered here? | External cognition
How many evaluation approaches | 3
DECIDE framework has ___ items | 6
Field studies are done in ______ environments. | natural
Select the last step in Interaction Design | Evaluating designs
Which of the following belong to criticisms of anthropomorphism? | All
Select the kind of conversation that are supported in real-time through voice or typing. | Synchronous computer-mediated communication
Which of the following statements belong to 'Visibility of system status' rule developed by Nielsen? | Always keep the user informed about what is going on through providing appropriate feedback in a reasonable time
"Explore the questions" is the ____ step in DECIDE framework. | second
All of the following are true about Personas except: | are vague and generalize the population
Who is involved in interaction design? | Multidisciplinary teams, where the skill sets of engineers, desigers, programmners, psychologists, anthropologists...
___________ are type of walkthrough in which users, developers and usability experts work together to step through a scenario, discussing usability issues associated with dialog elements involved in the scenario steps. | Pluralistic walkthroughs
Which kind of analytical evaluation model does the GOMS model belong to? | Predictive analytical evaluation model
_________ frequent your primary personas access the site,____________ transient a stance the site needs to take (respectively). |  Less, More
Which is the central activity of Star lifecycle model in HCI? | Evaluation
Which type of requirement is used to describe what the product should do? | Functional requirements
Select incorrect statement about field study. | Filed study does not involves user in evaluation
What does MHP stand for? | Model human processor
Which is not usability goal? | Helpful to use
Which is technique for quantitative analysis? | Charts
Reducing required time for data analysis is advantage of ____________. | Online questionnaires
The ______ interaction type involves user moving through virtual or physical environments. |  exploring
Which interface type is designed to enable users to interact with objects and navigate in 3D space? | Virtual reality
Which attribute of a method is concerned with how well it produces the same results on separate occasions under the same circumstances? | Reliability
Which is NOT a type of inspection technique in analytical evaluation? | Predictive models
Select the correct statements about memory | It involves first encoding and then retrieving knowledge
Select the interaction types of ATM machines: | Instructing
X-rays and scans machine, which are being used in medicine, is an example of __________. | Augmented and mixed reality interfaces.
_______ are used to describe what the product should do. | Functional requirements
Select advice for designing a questionnaire: | Provide clear instructions on how to complete the questionnaire
About ethical issues of evaluation, the participants don’t have a right to_______ | Begin any time when they can
In software engineering , which type of requirement is used to describe what the constraints there are on the system and its development? | Non-functional requirement
Which one of these is a good reason to include sounds in an HCI? | Users react more quickly to sounds than to visual signals
What does HTA involve? | All
The cognitive walkthrough is conducted by members of the design team | true
Which is NOT an issue of data gathering? | none
Why do we need to understand users?  | Understanding users is a obligation of each contract.
Which of the following properties does not belong to vision? | Sequential
Which kind of interfaces combine different media (graphics, text, video, sound, animation..) within a single interface and links them with various form of interactivity? | Multimedia
____ were invented to overcome physical constraints of a computer display, enabling more information to be viewed and tasks to be performed | Windows
Which of the following that does not belong to Nielsen's heuristic? | Maker control and freedom.
All of the following statements about attention are true except | Information at the interface should be structured to avoid users' attention
What does it mean by compromise in prototyping? | The intention is to produce something quickly to test an aspect of the product
____ determine ways of restricting the kinds of user interaction that can take place at a given moment. | Constraints
